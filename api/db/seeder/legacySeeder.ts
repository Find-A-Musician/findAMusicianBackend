...
export async function legacySeeder(connection: Connection): Promise<any> {
  try {
    // get All the repo
    ...
    const instruments = [batterie, guitare, piano];
